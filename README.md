...
## Manual
[Build a GraphRAG Agent with Neo4j and Qdrant](https://qdrant.tech/documentation/examples/graphrag-qdrant-neo4j/#build-a-graphrag-agent-with-neo4j-and-qdrant)
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/alexy-os/graphrag.git
   cd graphrag
   ```
